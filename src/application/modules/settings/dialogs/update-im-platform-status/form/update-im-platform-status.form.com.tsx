...
import {
    type UpdateImPlatformStatusFormInput,
    type UpdateImPlatformStatusFormOutput,
    UpdateImPlatformStatusFormSchema,
} from "../schemas";
...
export function UpdateImPlatformStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateImPlatformStatusFormInput, unknown, UpdateImPlatformStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateImPlatformStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateImPlatformStatusFormOutput) {
        if (isReadOnly) {
            return;
        }
    ...
    function onInvalid(_errors: FieldErrors<UpdateImPlatformStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateImPlatformStatusFormOutput) => void;
    initialValues?: Partial<UpdateImPlatformStatusFormInput>;
