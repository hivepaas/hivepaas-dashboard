...
import {
    type UpdateRegistryAuthStatusFormInput,
    type UpdateRegistryAuthStatusFormOutput,
    UpdateRegistryAuthStatusFormSchema,
} from "../schemas";
...
export function UpdateRegistryAuthStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateRegistryAuthStatusFormInput, unknown, UpdateRegistryAuthStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateRegistryAuthStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateRegistryAuthStatusFormOutput) {
        onSubmit(values);
    }

    function onInvalid(_errors: FieldErrors<UpdateRegistryAuthStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateRegistryAuthStatusFormOutput) => void;
    initialValues?: Partial<UpdateRegistryAuthStatusFormInput>;
