...
import {
    type UpdateBasicAuthStatusFormInput,
    type UpdateBasicAuthStatusFormOutput,
    UpdateBasicAuthStatusFormSchema,
} from "../schemas";
...
export function UpdateBasicAuthStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateBasicAuthStatusFormInput, unknown, UpdateBasicAuthStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateBasicAuthStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateBasicAuthStatusFormOutput) {
        onSubmit(values);
    }

    function onInvalid(_errors: FieldErrors<UpdateBasicAuthStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateBasicAuthStatusFormOutput) => void;
    initialValues?: Partial<UpdateBasicAuthStatusFormInput>;
