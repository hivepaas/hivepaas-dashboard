...
import {
    type UpdateGithubAppStatusFormInput,
    type UpdateGithubAppStatusFormOutput,
    UpdateGithubAppStatusFormSchema,
} from "../schemas";
...
export function UpdateGithubAppStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateGithubAppStatusFormInput, unknown, UpdateGithubAppStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateGithubAppStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateGithubAppStatusFormOutput) {
        if (isReadOnly) {
            return;
        }
    ...
    function onInvalid(_errors: FieldErrors<UpdateGithubAppStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateGithubAppStatusFormOutput) => void;
    initialValues?: Partial<UpdateGithubAppStatusFormInput>;
