...
import {
    type UpdateAcmeDnsProviderStatusFormInput,
    type UpdateAcmeDnsProviderStatusFormOutput,
    UpdateAcmeDnsProviderStatusFormSchema,
} from "../schemas";
...
export function UpdateAcmeDnsProviderStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        resolver: zodResolver(UpdateAcmeDnsProviderStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateAcmeDnsProviderStatusFormOutput) {
        if (isReadOnly) {
            return;
        }
    ...
    function onInvalid(_errors: FieldErrors<UpdateAcmeDnsProviderStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateAcmeDnsProviderStatusFormOutput) => void;
    initialValues?: Partial<UpdateAcmeDnsProviderStatusFormInput>;
