...
import {
    type UpdateSSHKeyStatusFormInput,
    type UpdateSSHKeyStatusFormOutput,
    UpdateSSHKeyStatusFormSchema,
} from "../schemas";
...
export function UpdateSSHKeyStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateSSHKeyStatusFormInput, unknown, UpdateSSHKeyStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateSSHKeyStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onInvalid(_errors: FieldErrors<UpdateSSHKeyStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateSSHKeyStatusFormOutput) => void;
