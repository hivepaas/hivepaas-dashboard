...
export class ProjectEmailApi extends BaseApi {
    ...
    async createOne(
        ...
        return lastValueFrom(
            from(
                this.client.v1.post(getProjectEmailBasePath(projectID, env), payload, {
                    signal,
                }),
            ).pipe(
    ...
    async updateOne(
        ...
        return lastValueFrom(
            from(
                this.client.v1.put(`${getProjectEmailBasePath(projectID, env)}/${id}`, payload, {
                    signal,
                }),
            ).pipe(
    ...
    async updateStatus(
        ...
        return lastValueFrom(
            from(
                this.client.v1.put(`${getProjectEmailBasePath(projectID, env)}/${id}/status`, payload, {
                    signal,
                }),
            ).pipe(
