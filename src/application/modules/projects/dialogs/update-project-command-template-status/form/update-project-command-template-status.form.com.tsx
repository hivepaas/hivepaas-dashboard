...
import {
    type UpdateProjectCommandTemplateStatusFormInput,
    type UpdateProjectCommandTemplateStatusFormOutput,
    UpdateProjectCommandTemplateStatusFormSchema,
} from "../schemas";
...
export function UpdateProjectCommandTemplateStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateProjectCommandTemplateStatusFormInput, unknown, UpdateProjectCommandTemplateStatusFormOutput>({
        defaultValues: {
        ...
        resolver: zodResolver(UpdateProjectCommandTemplateStatusFormSchema),
        mode: "onSubmit",
    });
    ...
    function onValid(values: UpdateProjectCommandTemplateStatusFormOutput) {
        if (isReadOnly) {
            return;
        }
    ...
    function onInvalid(_errors: FieldErrors<UpdateProjectCommandTemplateStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateProjectCommandTemplateStatusFormOutput) => void;
    initialValues?: Partial<UpdateProjectCommandTemplateStatusFormInput>;
