...
import {
    type UpdateProjectCommandPipeStatusFormInput,
    type UpdateProjectCommandPipeStatusFormOutput,
    UpdateProjectCommandPipeStatusFormSchema,
} from "../schemas";
...
export function UpdateProjectCommandPipeStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateProjectCommandPipeStatusFormInput, unknown, UpdateProjectCommandPipeStatusFormOutput>({
        defaultValues: {
    ...
    function onInvalid(_errors: FieldErrors<UpdateProjectCommandPipeStatusFormOutput>) {
...
interface Props {
    isPending: boolean;
    onSubmit: (values: UpdateProjectCommandPipeStatusFormOutput) => void;
    initialValues?: Partial<UpdateProjectCommandPipeStatusFormInput>;
