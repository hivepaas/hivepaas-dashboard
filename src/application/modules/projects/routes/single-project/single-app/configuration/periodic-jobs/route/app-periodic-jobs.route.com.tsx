...
import { AppHealthChecksTableDefs } from "~/projects/module-shared/definitions/tables/app-periodic-jobs";
...
export function AppPeriodicJobsRoute() {
    ...
    const columns = useMemo(() => AppHealthChecksTableDefs.columns(projectId, env, appId), [projectId, env, appId]);
                        ...
                        >
                            {({ isDenied }) => (
                                <Button
                                    onClick={() => {
                                        navigate.modules(
                                            ROUTE.projects.single.apps.single.configuration.periodicJobs.create.$route(
                                                projectId,
                                                env,
                                                appId,
                                            ),
