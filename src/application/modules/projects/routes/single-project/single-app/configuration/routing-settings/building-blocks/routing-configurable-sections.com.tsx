...
export function RoutingConfigurableSections({ basePath, readOnly = false }: RoutingConfigurableSectionsProps) {
...
export { RoutingConfigurableSections as HttpConfigurableSections };
