...
const ulimitsGridClass = "grid grid-cols-1 sm:grid-cols-10 flex-1 gap-2 items-center";
    ...
    return (
        ...
        >
            <FieldListLayout
                ...
                inputRow={
                    <>
                        <div className="col-span-1 sm:col-span-4 flex items-center rounded-md border border-input h-9 flex-1">
                            ...
                            <EditableCombobox
                                ...
                                onChange={setName}
                                placeholder="nofile"
                                className="-mx-px flex-1 gap-0 min-w-0"
                                inputClassName="h-9 border-0 shadow-none focus-visible:ring-0 rounded-l-none text-xs sm:text-sm"
                            />
                        </div>
                        <InputNumberWithAddon
                            ...
                            useGrouping={false}
                            placeholder="1024"
                            classNameContainer="col-span-1 sm:col-span-3 min-w-0"
                        />
                        <InputNumberWithAddon
                            addonLeft="Hard"
                            value={hard}
                                ...
                                {isEditing ? (
                                    <>
                                        <EditableCombobox
                                            ...
                                            placeholder="nofile"
                                            className="-mx-px flex-1 gap-0 col-span-1 sm:col-span-4 min-w-0"
                                        />
                                        <InputNumber
                                            value={draftSoft}
                                            onValueChange={v => {
                                            ...
                                            useGrouping={false}
                                            placeholder="1024"
                                            className="h-8 col-span-1 sm:col-span-3 min-w-0"
                                        />
                                        <InputNumber
                                            value={draftHard}
                                            onValueChange={v => {
                                    ...
                                    <>
                                        <div className="text-sm wrap-break-word col-span-1 sm:col-span-4 font-medium">
                                            {field.name}
                                        </div>
                                        <div className="text-sm wrap-break-word col-span-1 sm:col-span-3 flex items-center gap-1.5">
                                            <span className="text-xs text-muted-foreground sm:hidden">Soft:</span>
                                            <span>{field.soft}</span>
                                        </div>
                                        <div className="text-sm wrap-break-word col-span-1 sm:col-span-3 flex items-center gap-1.5">
                                            <span className="text-xs text-muted-foreground sm:hidden">Hard:</span>
                                            <span>{field.hard}</span>
                                        </div>
                                    </>
                                )}
                            </div>
