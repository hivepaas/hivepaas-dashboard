...
export const COMMAND_TEMPLATE_FROM_TEMPLATE_CATALOG = [
    {
        ...
        items: [
            ...
            {
                label: "ClickHouse Restore",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "clickhouse-restore",
            },
            {
            ...
            {
                label: "Dolt Restore (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "dolt-restore.pipe",
            },
            {
            ...
            {
                label: "InfluxDB Dump (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "influx-dump.pipe",
            },
            ...
            {
                label: "MariaDB Dump (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "mariadb-dump.pipe",
            },
            ...
            {
                label: "Neon Restore (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "neon-restore.pipe",
            },
            ...
            {
                label: "Postgres Restore (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "pg_restore.pipe",
            },
            ...
            {
                label: "Redis Restore (pipe)",
                commandType: ECommandTemplateKind.Backup,
                commandKind: "redis-restore.pipe",
            },
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "MySQL Table Size",
                commandType: ECommandTemplateKind.Diagnostics,
                commandKind: "mysql_table_size",
            },
            ...
            {
                label: "Postgres Table Size",
                commandType: ECommandTemplateKind.Diagnostics,
                commandKind: "pg_table_size",
            },
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "MariaDB Optimize",
                commandType: ECommandTemplateKind.Maintenance,
                commandKind: "mariadb_optimize",
            },
