...
import {
    type UpdateNetworkStatusFormInput,
    type UpdateNetworkStatusFormOutput,
    UpdateNetworkStatusFormSchema,
} from "../schemas";
...
export function UpdateNetworkStatusForm({
    isPending,
    onSubmit,
    initialValues,
    onHasChanges,
    ...
    const {
        ...
        control,
        formState: { errors },
    } = useForm<UpdateNetworkStatusFormInput, unknown, UpdateNetworkStatusFormOutput>({
        defaultValues: {
    ...
    function onValid(values: UpdateNetworkStatusFormOutput) {
        if (isReadOnly) {
            return;
        }
    ...
    function onInvalid(_errors: FieldErrors<UpdateNetworkStatusFormOutput>) {
