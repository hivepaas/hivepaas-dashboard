...
import { useAuditLogsApi } from "~/operations/api";
import type {
...
function useFindManyPaginated(request: FindManyPaginatedReq, options: FindManyPaginatedOptions = {}) {
    ...
    return useQuery({
        queryKey: [QK["operations.audit-logs.find-many-paginated"], request],
...
function useFindOneById(request: FindOneByIdReq, options: FindOneByIdOptions = {}) {
    ...
    return useQuery({
        queryKey: [QK["operations.audit-logs.find-one-by-id"], request],
...
function useFindTypes(request: FindTypesReq = {}, options: FindTypesOptions = {}) {
    ...
    return useQuery({
        queryKey: [QK["operations.audit-logs.find-types"], request],
